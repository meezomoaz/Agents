...
agent_log_file = os.path.expanduser('~/DataBaseAgent.log')
...
class DBAgent(Agent):
    ...
    def init_database(self):
        ...
        self.database_path = os.path.expanduser('~/inverter_operations.db')
    ...
    def read_files_and_update_data(self):
        ...
        local_input_file = '/home/taha/volttron/InverterSharedFiles/LocalInputs.txt'
        ...
        remote_input_file = '/home/taha/volttron/InverterSharedFiles/RemoteInputs.txt'
